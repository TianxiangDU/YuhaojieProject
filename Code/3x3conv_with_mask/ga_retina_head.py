...
class GARetinaHead(GuidedAnchorHead):
    ...
    def _init_layers(self):
        ...
        self.conv_feat_cls = nn.Conv2d(self.feat_channels, self.feat_channels, kernel_size = 3, stride = 1, padding = 1)
        self.conv_feat_reg = nn.Conv2d(self.feat_channels, self.feat_channels, kernel_size = 3, stride = 1, padding = 1)
    ...
    def forward_single(self, x):
        ...
        # using a 3x3 conv instead of deformable conv
        # cls_feat = self.conv_feat_cls(cls_feat)
        # reg_feat = self.conv_feat_reg(reg_feat)
